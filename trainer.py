...
def train():
    ...
    # 2. Dataloaders
    train_loader, val_loader = get_dataloaders(batch_size=cfg.BATCH_SIZE, num_workers=0)
    ...
    for epoch in range(1, cfg.EPOCHS + 1):
        ...
        for step in range(steps_per_epoch):
            try:
                ...
                train_loader, val_loader = get_dataloaders(batch_size=cfg.BATCH_SIZE, num_workers=0, seed=epoch+step)
                train_iter = iter(train_loader)
                z_batch = next(train_iter)
